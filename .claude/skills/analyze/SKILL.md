...
1. Read .claude/rules-reference/domain-profile.md for field conventions
...
4. **Comparison step** — verify numerical alignment per `.claude/rules-reference/domain-profile.md` tolerances:
