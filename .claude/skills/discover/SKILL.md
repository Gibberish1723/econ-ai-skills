...
- Domain profile → `.claude/rules-reference/domain-profile.md` (if still template)
...
Workflow:
1. Read .claude/rules-reference/domain-profile.md for field journals and seminal references
...
- **Domain-profile aware:** Always read .claude/rules-reference/domain-profile.md first for field calibration.
